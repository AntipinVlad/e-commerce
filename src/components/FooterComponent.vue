        ...
        <div class="xl:flex lg:flex md:flex pt-6">
          <div class="w-11/12 xl:w-3/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0">
            <div class="flex items-center mb-6 xl:mb-0 lg:mb-0">
              <UILogoComponent />
              <p class="ml-3 font-bold text-xl">Sport Beauty</p>
            </div>
          </div>
        </div>
        <div
          class="xl:flex flex-wrap justify-between xl:mt-16 mt-11 pb-6 pl-3 sm:pl-0"
        >
          <div class="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 xl:mb-0">
            <p class="text-gray-800 text-base">
              2021 Sport Beauty. All Rights Reserved
            </p>
          </div>
          <div
...
<script>
import UILogoComponent from "@/components/ui/UILogoComponent";
